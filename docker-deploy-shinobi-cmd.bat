...
SET VIDEOSTORAGE=W:/Security/shinobi
REM SET DBSTORAGE=C:/Docker_projects/shinobi/database
SET CONFIGSTORAGE=C:/Docker_projects/shinobi/config
...
docker volume create shinobi-database
...
docker create^
  ...
  --mount source=shinobi-database,target=/var/lib/mysql ^
